...
function [theta_nodes,er_hat_nodes,Consensus_all_nodes,erm_mean_nodes1,erm_mean_nodes2,erm_mean_nodes3,erm_mean_nodes4,erm_mean_nodes5]=Domkl_online_rf(y,X,params,Connectivity)
N=params.N; T=params.T; ker_list=params.ker_list;   
